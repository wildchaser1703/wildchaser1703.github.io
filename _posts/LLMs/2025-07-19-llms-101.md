...
## <a id="introduction"></a>1. Introduction to Large Language Models (LLMs)
...
## <a id="architecture"></a>2. Architecture of LLMs
...
### Diagram
![Transformer Architecture](https://www.jeremyjordan.me/content/images/2023/05/multi-head-attention.png)

---

## <a id="tokenization"></a>3. Tokenization and Embeddings
...
## <a id="attention"></a>4. Attention Mechanism
...
## <a id="training"></a>5. Training LLMs
...
## <a id="inference"></a>6. Inference and Decoding Strategies
...
## <a id="evaluation"></a>7. Evaluation Metrics
...
## <a id="quantization"></a>8. Quantization
...
## <a id="rag"></a>9. Retrieval-Augmented Generation (RAG)
...
## <a id="multimodal"></a>10. Multi-modal LLMs
...
## <a id="custom-training"></a>11. Custom Model Training
...
## <a id="conclusion"></a>12. Conclusion
